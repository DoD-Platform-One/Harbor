...
![Version: 1.8.1-bb.0](https://img.shields.io/badge/Version-1.8.1--bb.0-informational?style=flat-square) ![AppVersion: 2.4.1](https://img.shields.io/badge/AppVersion-2.4.1-informational?style=flat-square)
...
| persistence.persistentVolumeClaim.jobservice.existingClaim | string | `""` |  |
| persistence.persistentVolumeClaim.jobservice.storageClass | string | `""` |  |
| persistence.persistentVolumeClaim.jobservice.subPath | string | `""` |  |
| persistence.persistentVolumeClaim.jobservice.accessMode | string | `"ReadWriteOnce"` |  |
| persistence.persistentVolumeClaim.jobservice.size | string | `"1Gi"` |  |
...
| portal.image.tag | string | `"v2.4.1"` |  |
...
| jobservice.image.tag | string | `"v2.4.1"` |  |
...
| registry.registry.image.tag | string | `"v2.4.1"` |  |
| registry.controller.image.repository | string | `"goharbor/harbor-registryctl"` |  |
| registry.controller.image.tag | string | `"v2.4.1"` |  |
...
| chartmuseum.image.repository | string | `"goharbor/chartmuseum-photon"` |  |
| chartmuseum.image.tag | string | `"v2.4.1"` |  |
...
| notary.server.image.repository | string | `"goharbor/notary-server-photon"` |  |
| notary.server.image.tag | string | `"v2.4.1"` |  |
...
| notary.signer.image.repository | string | `"goharbor/notary-signer-photon"` |  |
| notary.signer.image.tag | string | `"v2.4.1"` |  |
...
| database.internal.image.tag | string | `"v2.4.1"` |  |
...
| redis.internal.image.tag | string | `"v2.4.1"` |  |
...
| exporter.image.tag | string | `"v2.4.1"` |  |
