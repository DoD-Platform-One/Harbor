...
| portal.image.tag | string | `"v2.8.4"` |  |
...
| jobservice.image.tag | string | `"v2.8.4"` |  |
...
| registry.registry.image.tag | string | `"v2.8.4"` |  |
...
| registry.controller.image.tag | string | `"v2.8.4"` |  |
...
| chartmuseum.image.tag | string | `"v2.7.2"` |  |
...
| notary.server.image.tag | string | `"v2.8.4"` |  |
...
| notary.containerSecurityContext.securityContext.runAsUser | int | `1000` |  |
| notary.containerSecurityContext.securityContext.runAsGroup | int | `1000` |  |
...
| notary.signer.image.tag | string | `"v2.8.4"` |  |
...
| notary.signer.containerSecurityContext.securityContext.runAsUser | int | `1000` |  |
| notary.signer.containerSecurityContext.securityContext.runAsGroup | int | `1000` |  |
...
| redis.internal.image.tag | string | `"v2.8.4"` |  |
...
| exporter.image.tag | string | `"v2.8.4"` |  |
