...
| portal.image.tag | string | `"v2.11.1"` |  |
...
| jobservice.image.tag | string | `"v2.11.1"` |  |
...
| registry.registry.image.tag | string | `"v2.11.1"` |  |
...
| registry.controller.image.tag | string | `"v2.11.1"` |  |
...
| trivy.image.tag | string | `"v2.11.1"` |  |
...
| database.internal.image.tag | string | `"v2.11.1"` |  |
...
| redis.internal.image.tag | string | `"v2.11.1"` |  |
...
| exporter.image.tag | string | `"v2.11.1"` |  |
