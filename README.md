...
![Version: 1.14.2-bb.5](https://img.shields.io/badge/Version-1.14.2--bb.5-informational?style=flat-square) ![AppVersion: 2.10.2](https://img.shields.io/badge/AppVersion-2.10.2-informational?style=flat-square)
...
| portal.image.tag | string | `"v2.10.2"` |  |
...
| jobservice.image.tag | string | `"v2.10.2"` |  |
...
| registry.registry.image.tag | string | `"v2.10.2"` |  |
...
| registry.controller.image.tag | string | `"v2.10.2"` |  |
...
| trivy.image.tag | string | `"v2.10.2"` |  |
...
| redis.internal.image.tag | string | `"v2.10.2"` |  |
...
| exporter.image.tag | string | `"v2.10.2"` |  |
