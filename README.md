...
![Version: 1.9.3-bb.0](https://img.shields.io/badge/Version-1.9.3--bb.0-informational?style=flat-square) ![AppVersion: 2.5.3](https://img.shields.io/badge/AppVersion-2.5.3-informational?style=flat-square)
...
| persistence.persistentVolumeClaim.jobservice.annotations | object | `{}` |  |
...
| portal.image.tag | string | `"v2.5.3"` |  |
...
| jobservice.image.tag | string | `"v2.5.3"` |  |
...
| registry.registry.image.tag | string | `"v2.5.3"` |  |
| registry.controller.image.repository | string | `"goharbor/harbor-registryctl"` |  |
| registry.controller.image.tag | string | `"v2.5.3"` |  |
...
| chartmuseum.image.tag | string | `"v2.5.3"` |  |
...
| notary.server.image.tag | string | `"v2.5.3"` |  |
...
| notary.signer.image.tag | string | `"v2.5.3"` |  |
...
| exporter.image.tag | string | `"v2.5.3"` |  |
